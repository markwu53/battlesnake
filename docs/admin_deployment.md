...
7. Next, we'll add the participant as a developer in the repo. Select `Manage` > `Members`.

   <img src="assets/admin_deployment/80_open_members.png" alt="New GitLab Project" height="550">
8. Select `Invite members` in the upper right-hand side of the `Project members` menu.

   <img src="assets/admin_deployment/81_invite_members.png" alt="New GitLab Project" height="300">
9. Add the participant as a `Developer`. Leave the `Access expiration date` empty. Select `Invite`.

   <img src="assets/admin_deployment/82_add_member.png" alt="New GitLab Project" height="450">
10. If the participant isn't already registered with GitLab, direct them to log in to https://git.mmi.mig.corp/ using
    their T-number and standard password. **Note: The `T` will need to be lowercase.** For example, use `t123456`
    instead
    of `T123456`. This will add you to a list of users pending approval, allowing the Release management team to approve
    your onboarding.
11. Next, we'll get ready to create GitLab CI/CD variables. Navigate back to the GitLab repository and select
    `Settings` > `CI/CD`.

    <img src="assets/admin_deployment/30_set_cicd_variables_1.png" alt="New GitLab Project" height="500">
12. Select `Variables` to expand the category. Keep this window up as you complete the next steps with Railway.

    <img src="assets/admin_deployment/31_set_cicd_variables_2.png" alt="New GitLab Project" height="400">

13. Add the participant as a developer # TODO: add these screenshots
