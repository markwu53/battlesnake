...
def main(game_state, log=True, log_db=False):
    ...
    def avoid_two_snake_trap(moves):
        ...
        def config_10(moves):
            ...
            single_collision = take_first([a for a in moves if is_adjacent(a, two.head)])
...
if __name__ == "__main__":
    ...
    log = {'id': 'c93f4b47-872a-4025-9b0c-4376d172da7c', 'turn': 8, 'me': {'name': 'mark_snake', 'health': 94, 'length': 4, 'body': [(4, 4), (4, 3), (3, 3), (3, 2)], 'id': 'gs_PCJvDfkM8QJWwjFXTvf4PxxJ'}, 'others': [{'name': 'Kakemonsteret-v2', 'health': 100, 'length': 6, 'body': [(2, 4), (2, 5), (2, 6), (2, 7), (1, 7), (1, 7)], 'id': 'gs_vdH9Jjd7CKYYyQ9rg4fhPtkS'}, {'name': 'Lancer', 'health': 96, 'length': 4, 'body': [(6, 8), (7, 8), (7, 9), (8, 9)], 'id': 'gs_tHBkQ3hgGxRpHjvCrb3rgbbS'}, {'name': 'Frank The Tank', 'health': 94, 'length': 4, 'body': [(5, 3), (5, 2), (6, 2), (6, 1)], 'id': 'gs_xkdtgfxypcfpxS866dmkb8q9'}], 'food': [(5, 5)], 'module': 'decision_flow', 'decision_path': ['1vn', 'avoid single collision [(3, 4)]', 'avoid two-snake trap'], 'next_coord': (5, 4), 'next_move': 'right', 'time': '0.008s'}
