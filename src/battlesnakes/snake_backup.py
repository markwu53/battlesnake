...
#this gives me #20 score 8561 on 6/1/2025
    ...
    def avoid_danger():
        ...
        def occupied_cells(step=1):
            return [cell 
                ...
                for hbody in [body if snake["health"] != 100 else body+[body[-1]]]
                for cell in hbody[:-step]
                ]
        ...
        def rank99(result):
            ...
            result.sort(key=lambda move: 1 if on_border(move) else 0)
